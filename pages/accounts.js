...
export default function AccountsPage() {
  ...
  useEffect(() => {
    // مستخدمون تجريبيون
    const demoUsers = [
      { id: "U-1", name: "أحمد", role: "كاشير" },
      { id: "U-2", name: "سارة", role: "إدارية" },
      { id: "U-3", name: "محمد", role: "مدير" },
    ];
    ...
    const demoTrans = [
      {
        ...
        direction: "in",
        amount: 320.5,
        date: "2025-11-16T10:22:00",
        userId: "U-1",
        userName: "أحمد",
        category: "مبيعات",
        paymentMethod: "cash",
        description: "فاتورة بيع أدوية متنوعة",
      },
      {
        id: "T-1002",
        refCode: "INV-1002",
        ...
        direction: "in",
        amount: 145.0,
        date: "2025-11-16T12:10:00",
        userId: "U-2",
        userName: "سارة",
        category: "مبيعات",
        paymentMethod: "card",
        description: "فاتورة لعميل نقداً/بطاقة",
      },
      {
        id: "T-1003",
        refCode: "RET-1001",
        ...
        direction: "out",
        amount: 50.0,
        date: "2025-11-16T14:40:00",
        userId: "U-1",
        userName: "أحمد",
        category: "مرتجعات",
        paymentMethod: "cash",
        description: "مرتجع جزء من فاتورة",
      },
      {
        id: "T-1004",
        refCode: "EXP-PO-01",
        ...
        paymentMethod: "bank",
        description: "شراء دواء مخزون من المورد",
      },
      {
        id: "T-1005",
        refCode: "EXP-RENT-01",
        ...
        direction: "out",
        amount: 450.0,
        date: "2025-11-10T08:10:00",
        userId: "U-3",
        userName: "محمد",
        category: "إيجار",
        paymentMethod: "bank",
        description: "إيجار الصيدلية الشهري",
      },
      {
        id: "T-1006",
        refCode: "OTH-INC-01",
        ...
        paymentMethod: "cash",
        description: "عمولة خدمة استشارة",
      },
    ];
