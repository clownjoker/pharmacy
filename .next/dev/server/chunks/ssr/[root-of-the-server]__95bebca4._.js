...
function ShiftsPage() {
    ...
    const loadData = async ()=>{
        try {
            ...
            const [cur, list] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/shifts/current"),
                __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/shifts")
            ]);
    ...
    const startShift = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/shifts/start", {
                userId
            });
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error(err.response?.data?.message || "تعذر بدء الشفت");
        }
    };
    // -----------------------------------------------------
    // 🔴 إغلاق الشفت
    ...
    const closeShift = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/shifts/close", {
                userId
            });
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error(err.response?.data?.message || "تعذر إغلاق الشفت");
        }
    };
    // -----------------------------------------------------
    // 🎨 واجهة العرض
