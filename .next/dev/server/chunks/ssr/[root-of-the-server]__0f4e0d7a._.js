...
function SalesPage() {
    ...
    const { products: invProducts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$InventoryContext$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useInventory"])();
    ...
    const [dbProducts, setDbProducts] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([]);
    const [productsLoading, setProductsLoading] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(false);
    // فلاتر
    ...
    const products = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useMemo"])(()=>{
    ...
    const loadSales = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في تحميل المبيعات");
        } finally{
            setLoading(false);
        }
    };
    ...
    const loadProducts = async ()=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/products");
            const list = res.data || [];
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("تعذر تحميل المنتجات من قاعدة البيانات");
            setDbProducts([]);
        } finally{
    ...
    const handleAddLine = ()=>{
        if (!lineProductId) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("اختر منتجًا أولًا");
            return;
        }
        ...
        if (!qty || qty <= 0) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("الكمية غير صحيحة");
            return;
        }
        const price = linePrice !== "" ? Number(linePrice) : Number(product.price || 0);
        if (!price || price <= 0) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("سعر البيع غير صحيح");
            return;
        }
        const newItem = {
    ...
    const handleSaveSale = async ()=>{
        if (!(saleForm.items || []).length) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("أضف منتجًا واحدًا على الأقل للفاتورة");
            return;
        }
        try {
            const payload = {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("تم حفظ الفاتورة بنجاح");
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("فشل حفظ الفاتورة");
        }
    };
    // حذف فاتورة
    const handleDeleteSale = async (id)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("تم حذف الفاتورة");
        } catch (err) {
            console.error("delete sale error:", err);
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في حذف الفاتورة");
        }
    };
    // فتح تفاصيل الفاتورة
    const openSaleDetails = async (sale)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في تحميل تفاصيل الفاتورة");
        } finally{
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    !productsLoading && !(products || []).length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
