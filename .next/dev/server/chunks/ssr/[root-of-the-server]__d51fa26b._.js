...
function Cashier() {
    ...
    const [tax, setTax] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(0);
    const [paymentMethod, setPaymentMethod] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])("cash");
    const [customer, setCustomer] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])("عميل نقدي");
    const [invoices, setInvoices] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([]); // فواتير وهمية محليًا
    const [shiftOpen, setShiftOpen] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(false);
    // 🔹 فلترة المنتجات حسب البحث
    const filteredProducts = PRODUCTS.filter((p)=>p.name.toLowerCase().includes(search.toLowerCase()));
    // 🔹 إضافة منتج للسلة
    const addToCart = (p)=>{
        if (!shiftOpen) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("⚠️ يجب فتح شِفت قبل البدء في البيع");
            return;
        }
    ...
    const handleOpenShift = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["openShift"])(user.name);
        setShiftOpen(true);
        __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("✅ تم فتح الشِفت للكاشير");
    };
    // 🔹 إغلاق شفت
    const handleCloseShift = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["closeShift"])(user.name);
        setShiftOpen(false);
        __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("✅ تم إغلاق الشِفت");
    };
    // 🔹 حفظ الفاتورة وربطها بالمبيعات + المخزون + الشِفت
    const saveInvoice = ()=>{
        if (!shiftOpen) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("⚠️ افتح شِفت أولاً");
            return;
        }
        if (cart.length === 0) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("لم يتم اختيار أي منتج");
            return;
        }
        ...
        const saved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["addSale"])(invoice);
        // 2) خصم الكميات من المخزون
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["applySaleToInventory"])(saved);
        ...
        setDiscount(0);
        setTax(0);
        __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("🧾 تم حفظ الفاتورة وتحديث المبيعات والمخزون (محليًا)");
    };
    // 🔹 طباعة الفاتورة
                                ...
                                cart.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tbody", {
                                            children: cart.map((it)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tr", {
                                                    className: "border-t",
                                                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        filteredProducts.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                                        ...
                                        filteredProducts.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d51fa26b._.js.map