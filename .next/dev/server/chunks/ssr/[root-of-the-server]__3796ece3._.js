...
function PharmacistPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const loadData = async ()=>{
            try {
                ...
                console.error(err);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error('⚠️ فشل الاتصال بسيرفر الصيدلي');
            }
        };
        loadData();
    }, []);
    ...
    const submitSale = async ()=>{
        ...
        try {
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error(err.message || 'حدث خطأ أثناء تسجيل البيع');
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3796ece3._.js.map