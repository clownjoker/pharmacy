...
function UsersPage() {
    ...
    const loadUsers = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في تحميل المستخدمين");
        }
    };
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        loadUsers();
    ...
    const handleAddUser = async ()=>{
        if (!newUser.name || !newUser.username || !newUser.password) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("⚠️ يرجى إدخال الاسم واسم المستخدم وكلمة المرور");
            return;
        }
        try {
            const payload = {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/users", payload);
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("تم إضافة المستخدم بنجاح");
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("فشل إنشاء المستخدم");
        }
    };
    // 🔄 تفعيل / تعطيل مستخدم
    const toggleActive = async (id)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/users/${id}/toggle`);
            const newActive = typeof res.data?.active !== "undefined" ? !!res.data.active : undefined;
            setUsers((prev)=>prev.map((u)=>u.id === id ? {
                        ...u,
                        active: typeof newActive === "boolean" ? newActive : !u.active
                    } : u));
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("تم تحديث حالة المستخدم");
        } catch (err) {
            console.error("toggleActive error:", err);
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في تغيير حالة المستخدم");
        }
    };
    // 🗑️ حذف مستخدم
    const deleteUser = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/users/${id}`);
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("خطأ في حذف المستخدم");
        }
    };
    ...
    const togglePermission = (permKey)=>{
        setPermDraft((prev)=>prev.includes(permKey) ? prev.filter((p)=>p !== permKey) : [
                ...prev,
                permKey
            ]);
    };
    ...
    const savePermissions = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].put(`/users/${selectedUser.id}/permissions`, {
                permissions: permDraft
            });
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("تم حفظ الصلاحيات بنجاح");
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("فشل حفظ الصلاحيات");
        }
    };
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tbody", {
                                children: filteredUsers.length ? filteredUsers.map((u, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                    className: "px-3 py-1 text-xs border rounded-full text-sky-800 bg-sky-50 border-sky-200",
                                                    children: ROLE_LABELS[u.role_id] || "غير محدد"
                                                }, void 0, false, {
                                                    fileName: "[project]/pages/users.js",
                                                    lineNumber: 263,
                                                    columnNumber: 23
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                className: "px-3 py-2",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                    className: `px-3 py-1 text-xs rounded-full ${u.active ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`,
                                                    children: u.active ? "مفعّل" : "موقوف"
                                                }, void 0, false, {
                                                    fileName: "[project]/pages/users.js",
                                                    lineNumber: 268,
                                                    columnNumber: 23
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                                ...
                                                children: Array.isArray(u.permissions) && u.permissions.length ? u.permissions.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                                        className: "inline-block px-2 py-0.5 mx-0.5 mb-0.5 text-[11px] text-indigo-700 bg-indigo-50 rounded",
                                                        children: ALL_PERMISSIONS.find((x)=>x.key === p)?.label || p
                                                    }, p, false, {
                                                        fileName: "[project]/pages/users.js",
                                                        lineNumber: 281,
                                                        columnNumber: 27
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("td", {
                                        ...
                                        children: "لا توجد بيانات مستخدمين حتى الآن…"
                                    }, void 0, false, {
                                        fileName: "[project]/pages/users.js",
                                        lineNumber: 323,
                                        columnNumber: 19
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aef28425._.js.map