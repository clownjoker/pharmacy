...
function Dashboard() {
    ...
    const user = ("TURBOPACK compile-time truthy", 1) ? JSON.parse(localStorage.getItem("pharmacy_user")) : "TURBOPACK unreachable";
    // بيانات تجريبية
    const [salesData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            month: "يناير",
            total: 3200
        },
...
_s(Dashboard, "YsM84DQ0rUgxUhEH3+JwPWbjPLY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
