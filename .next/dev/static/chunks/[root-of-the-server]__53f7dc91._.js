...
"[project]/context/permissions.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$permissions$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/permissions.js [client] (ecmascript)");
;
...
function AuthProvider({ children }) {
    _s();
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null); // بيانات المستخدم
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true); // تحميل الجلسة
    ...
    const login = (username, password)=>{
        ...
        const permList = __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$permissions$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ROLE_DEFAULT_PERMISSIONS"][found.role] || [];
        const u = {
    ...
    const canAccessRoute = (path)=>{
        ...
        const perms = Array.isArray(required) ? required : [
            required
        ];
        if (!user.permissions) return false;
...
// 🔒 قواعد الحماية الصارمة لكل صفحة
const ROUTE_RULES = [
    {
        pattern: /^\/dashboard$/,
        roles: [
...
function AuthGuard({ children }) {
    ...
    const { ready, user, hasRole, hasPermission } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthGuard.useEffect": ()=>{
            ...
            // بدون مستخدم → رجوع للصفحة الرئيسية
            if (!user) {
                router.replace("/");
                return;
            }
            const rule = findRule(path);
            // Strict Mode ❌ أي صفحة غير معرفة → ممنوع الدخول
            if (!rule) {
                router.replace("/403");
                return;
            }
            // تحقق من الدور
            const roleOK = hasRole(rule.roles);
            const permOK = hasPermission(rule.permissions);
            if (!roleOK || !permOK) {
                router.replace("/403");
                return;
            }
 ...
 //   return children;
 // }
_s(AuthGuard, "RecUttUcd7fgZw6tYQJRFl3pGK4=", false, function() {
    return [
...
"[project]/components/Forbidden.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/components/Forbidden.js",
                lineNumber: 7,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                className: "mb-2 text-2xl font-bold text-red-600",
                children: "ليس لديك صلاحية لعرض هذه الصفحة"
            }, void 0, false, {
                fileName: "[project]/components/Forbidden.js",
                lineNumber: 8,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "الرجاء التواصل مع مدير النظام لتفعيل الصلاحية المطلوبة."
            }, void 0, false, {
                fileName: "[project]/components/Forbidden.js",
                lineNumber: 11,
                columnNumber: 7
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fa$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-icons/fa/index.mjs [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Forbidden$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/Forbidden.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function Dashboard() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, hasPermission, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            dir: "rtl",
    ...
    if (!hasPermission("view_dashboard")) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Forbidden$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/pages/dashboard.js",
            lineNumber: 44,
            columnNumber: 12
        }, this);
...
_s(Dashboard, "ifFV2+fcvl6GJVT3P4ngvaz2Tso=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__53f7dc91._.js.map