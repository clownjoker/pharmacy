...
"[project]/lib/fakeBackend.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/fakeBackend.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function Cashier() {
    ...
    const [paymentMethod, setPaymentMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("cash");
    const [customer, setCustomer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("عميل نقدي");
    const [invoices, setInvoices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]); // فواتير وهمية محليًا
    const [shiftOpen, setShiftOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // 🔹 فلترة المنتجات حسب البحث
    const filteredProducts = PRODUCTS.filter((p)=>p.name.toLowerCase().includes(search.toLowerCase()));
    // 🔹 إضافة منتج للسلة
    const addToCart = (p)=>{
        if (!shiftOpen) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("⚠️ يجب فتح شِفت قبل البدء في البيع");
            return;
        }
    ...
    const handleOpenShift = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$client$5d$__$28$ecmascript$29$__["openShift"])(user.name);
        setShiftOpen(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("✅ تم فتح الشِفت للكاشير");
    };
    // 🔹 إغلاق شفت
    const handleCloseShift = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$client$5d$__$28$ecmascript$29$__["closeShift"])(user.name);
        setShiftOpen(false);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("✅ تم إغلاق الشِفت");
    };
    // 🔹 حفظ الفاتورة وربطها بالمبيعات + المخزون + الشِفت
    const saveInvoice = ()=>{
        if (!shiftOpen) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("⚠️ افتح شِفت أولاً");
            return;
        }
        if (cart.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("لم يتم اختيار أي منتج");
            return;
        }
        ...
        const saved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$client$5d$__$28$ecmascript$29$__["addSale"])(invoice);
        // 2) خصم الكميات من المخزون
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fakeBackend$2e$js__$5b$client$5d$__$28$ecmascript$29$__["applySaleToInventory"])(saved);
        ...
        setDiscount(0);
        setTax(0);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("🧾 تم حفظ الفاتورة وتحديث المبيعات والمخزون (محليًا)");
    };
    // 🔹 طباعة الفاتورة
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        " ",
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: shiftOpen ? "text-emerald-600" : "text-red-600",
                                            children: shiftOpen ? "مفتوح" : "مغلق"
                                        }, void 0, false, {
                                            fileName: "[project]/pages/cashier.js",
                                            lineNumber: 220,
                                            columnNumber: 15
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 gap-3 mb-4 text-sm md:grid-cols-3",
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: "نوع الدفع يؤثر على التقارير لاحقًا فقط (بيانات تجريبية)."
                                        }, void 0, false, {
                                            fileName: "[project]/pages/cashier.js",
                                            lineNumber: 265,
                                            columnNumber: 15
                                ...
                                cart.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "لا يوجد منتجات مضافة بعد. اختر منتجًا من القائمة على اليمين."
                                }, void 0, false, {
                                    fileName: "[project]/pages/cashier.js",
                                    lineNumber: 271,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            onClick: saveInvoice,
                                            children: "💾 حفظ الفاتورة وتحديث النظام"
                                        }, void 0, false, {
                                            fileName: "[project]/pages/cashier.js",
                                            lineNumber: 333,
                                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        filteredProducts.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        filteredProducts.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
 ...
 //   )
 // }
_s(Cashier, "/f7zJLadHliLJ1g1e7Tst1zoaoc=");
_c = Cashier;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__858fc11b._.js.map