...
const resolveDirection = (t)=>{
    ...
    if (t.type?.includes("مصروف") || t.type?.includes("مرتجع")) {
        return "out";
    }
    // غير ذلك يعتبر إيراد
    return "in";
...
function AccountsPage() {
    ...
    const [directionFilter, setDirectionFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("all");
    const [userFilter, setUserFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("all");
    ...
    const [newTrans, setNewTrans] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])({
        userId: "",
        type: "فاتورة بيع",
        direction: "in",
        amount: "",
    ...
    const loadTransactions = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get("/transactions");
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("خطأ في تحميل العمليات");
        }
    };
    // 🔄 جلب المستخدمين من الباك-إند
    const loadUsers = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get("/users");
    ...
    // 🔍 فلترة العمليات
    const filteredTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AccountsPage.useMemo[filteredTransactions]": ()=>{
            return transactions.filter({
                "AccountsPage.useMemo[filteredTransactions]": (t)=>{
                    ...
                    const passDir = directionFilter === "all" || dir === directionFilter;
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AccountsPage.useMemo[summary]": ()=>{
            let income = 0;
            let expense = 0;
            filteredTransactions.forEach({
                "AccountsPage.useMemo[summary]": (t)=>{
            ...
            const dates = transactions.map({
                "AccountsPage.useMemo[summary].dates": (t)=>t.date?.slice(0, 10)
            }["AccountsPage.useMemo[summary].dates"]).filter(Boolean);
            ...
            if (logicalToday) {
                transactions.forEach({
                    "AccountsPage.useMemo[summary]": (t)=>{
                        const amount = Number(t.amount) || 0;
                        const dir = resolveDirection(t);
                        if (dir === "in" && t.date?.slice(0, 10) === logicalToday) {
                            todayIncome += amount;
                        }
                    }
                }["AccountsPage.useMemo[summary]"]);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AccountsPage.useMemo[chartData]": ()=>{
            const map = new Map();
            filteredTransactions.forEach({
                "AccountsPage.useMemo[chartData]": (t)=>{
            ...
            return Array.from(map.entries()).sort({
                "AccountsPage.useMemo[chartData]": ([a], [b])=>a > b ? 1 : -1
            }["AccountsPage.useMemo[chartData]"]).map({
                "AccountsPage.useMemo[chartData]": ([date, total])=>({
                        date,
                        total
                    })
            }["AccountsPage.useMemo[chartData]"]);
    ...
    const handleSaveNewTrans = async ()=>{
        try {
            if (!newTrans.userId || !newTrans.amount || !newTrans.date) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("يرجى إدخال المستخدم والمبلغ والتاريخ");
                return;
            }
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/transactions", payload);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("تم حفظ العملية بنجاح");
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("فشل في حفظ العملية");
        }
    };
    // تجميع حسب المستخدم (دفتر بسيط)
    const userLedger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AccountsPage.useMemo[userLedger]": ()=>{
            const map = new Map();
            transactions.forEach({
                "AccountsPage.useMemo[userLedger]": (t)=>{
                    if (!t.userId) return;
                    if (!map.has(t.userId)) {
                        map.set(t.userId, {
                            userId: t.userId,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    style: {
                                        background: __TURBOPACK__imported__module__$5b$project$5d2f$theme$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].colors.success
                                    },
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: userLedger.length ? userLedger.map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        users.map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: u.id,
                                                children: u.name
                                            }, u.id, false, {
                                                fileName: "[project]/pages/accounts.js",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: filteredTransactions.length ? filteredTransactions.map((t)=>{
                                        const dir = resolveDirection(t);
...
_s(AccountsPage, "T/JSdF4z1lvF7YOfR8UArIntNEo=");
_c = AccountsPage;
// بطاقة ملخص
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f050797._.js.map