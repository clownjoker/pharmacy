...
function CashierPage() {
    _s();
    const [invoiceId, setInvoiceId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CashierPage.useEffect": ()=>{
            const createInvoice = {
                "CashierPage.useEffect.createInvoice": async ()=>{
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/cashier/new", {
                        user_id: 1
                    });
                    setInvoiceId(res.data.invoice_id);
                }
            }["CashierPage.useEffect.createInvoice"];
            createInvoice();
        }
    }["CashierPage.useEffect"], []);
    // 🔍 البحث عن صنف
    ...
    const addItem = async (prod)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/cashier/add-item", {
    ...
    const loadInvoice = async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/cashier/${invoiceId}`);
        setItems(res.data.items);
    };
    // حذف الصنف
    const removeItem = async (item)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete(`/cashier/item/${item.id}`);
        loadInvoice();
    };
    // الدفع
    const checkout = async (method)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/cashier/checkout", {
            invoice_id: invoiceId,
            method
        });
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success(`تم الدفع بنجاح — الإجمالي ${res.data.total} ريال`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/cashier/deduct-stock", {
            invoice_id: invoiceId
        });
        // إنشاء فاتورة جديدة مباشرة
        const newInv = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/cashier/new", {
            user_id: 1
        });
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: filteredProducts.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
 ...
 //   )
 // }
_s(CashierPage, "OQytAbWwmLr6IXMAp4aPHij8iDM=");
_c = CashierPage;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__605c2972._.js.map