...
function Cashier() {
            ...
            const loadProducts = {
                "Cashier.useEffect.loadProducts": async ()=>{
                    try {
                        ...
                        console.error(err);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('⚠️ فشل الاتصال بالسيرفر لجلب المنتجات');
                    }
                }
    ...
    const addToCart = ()=>{
        if (!productId) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('يرجى اختيار منتج');
            return;
        }
        ...
        if (quantity <= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error('الكمية يجب أن تكون 1 أو أكثر');
            return;
        }
        setCart((prev)=>{
        ...
        setProductId('');
        setQuantity(1);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success('✅ تمت الإضافة للفاتورة');
    };
    const removeItem = (id)=>{
        setCart((prev)=>prev.filter((item)=>item.id !== id));
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success('تم حذف المنتج من الفاتورة');
    };
    const total = cart.reduce((sum, item)=>sum + item.price * item.quantity, 0);
    const netTotal = Math.max(0, total - (Number(discount) || 0));
    const completeSale = async ()=>{
        if (cart.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("لا توجد منتجات في الفاتورة");
            return;
        }
        try {
            ...
            if (!invData.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("فشل إنشاء الفاتورة");
                return;
            }
            ...
            if (!checkoutData.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("فشل إنهاء الفاتورة");
                return;
            }
            ...
            setCart([]);
            setDiscount(0);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("تمت عملية البيع بنجاح");
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("خطأ أثناء تنفيذ عملية البيع");
        }
    };
    ...
    const handleCloseShift = async ()=>{
        try {
            ...
            const data = await res.json();
            if (!data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error(data.message || "فشل إغلاق الوردية");
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("تم إغلاق الوردية بنجاح");
            setShowShiftReport(true);
            setCart([]);
        } catch (err) {
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("خطأ أثناء إغلاق الوردية");
        }
    };
    // طباعة الوردية
 ...
 //   );
 // }
_s(Cashier, "OTEZuIrq6YC+jz3J2GXcdCo3VMI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
